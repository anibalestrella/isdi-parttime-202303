                ...
                <div className='mt-4'>
                    ...
                    <div id='artist-list' className='w-full'>
                        {searchArtistList.slice(0, 5).map((item) => (
                            <div id='artist-list-item' key={item.id} className={`mt-2  ${selectedArtistId === item.id ? 'text-gray-300 bg-gray-80 rounded-xl ' : ' rounded-xl bg-gray-100  text-gray-300 '}`}>
                                <div className='flex justify-between items-center rounded-xl  hover:text-white hover:bg-gray-200 hover:drop-shadow-lg p-2 transition-all duration-100 cursor-pointer' onClick={() => handleToggleExpand(item.id)}>
