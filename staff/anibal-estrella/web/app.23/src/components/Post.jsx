...
export default function Post({ post: { author, id, image, text, date, likes }, user: { avatar, name, favs }, onEditPost, onToggledLikePost, onToggledFavPost }) {
        ...
        <article className="post panel">
            ...
            <div className="post-buttons">
                ...
                <button onClick={handleToggleFavPost} className="post-button fav-button icon">Fav
                    {favs.includes(id) ? <BookmarkIcon className="favIcon icon" />  : < BookmarkIconLine className="favIcon icon" />}
                </button>
            </div>
        </article>
